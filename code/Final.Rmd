...
This provides significant evidence that figure # (provided below) is an accurate way of visualizing the difference in total seed count between kangaroo rat mounds.  
